...
//        do {
//            let arr = try self.managedObjectContext.executeFetchRequest(fetch)
//            print("-----\(arr.count)-----")
//            
//            for ques in arr {
...
//        }
        ...
        //从XML文件解析
        //判断是否为第一次运行
        let hasLoadXML = NSUserDefaults.standardUserDefaults().boolForKey("hasLoadXML")
        
        if hasLoadXML == false {
            
            NSUserDefaults.standardUserDefaults().setBool(true, forKey: "hasLoadXML")
            NSUserDefaults.standardUserDefaults().synchronize()
            
            xmlAnalysis.fetchXMLData(fileName: "2015082816033575811715e-5b538a495fa6")
            xmlAnalysis.fetchXMLData(fileName: "20151015170129212125061-b2407ba143d3")
...
//        }
  ...
  print(questions?.count)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.kyp.ExamAnki" in the application's documents Application Support directory.
